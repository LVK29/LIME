...
int serverResponseCode = 0;
  ...
  public final static String
       FILE_TO_RECEIVED = "d:/temp/source-downloaded.docx";  
        ...
        PrintWriter out = response.getWriter();
         try {
           ...
           Split_Files sf=new Split_Files();
             sf.readAndFragment(path_info.path+"1/"+filePath, path_info.path+"chunks/", 1048*1048, "data");
