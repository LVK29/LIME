    ...
    <div class="mainmenu-area">
     ...
     <div class="col-md-12"><br/><br/>
         ...
         <table align="center" cellpadding="7" border="6">
             <tr><td>Name</td><td>File</td><td>Watermark</td><td>Download Link</td></tr>
              <%
               ...
               %>
                <form action="filedownload"><tr><td><%=ownername%></td><td><%=ownerfile%></td><td><img src= "<%=waterimg%>" alt="fprint view" style="width:150px;height:150px"></td>
                       <input type="hidden" name="ownername" value="<%=ownername%>"/>
                       <input type="hidden" name="ownerfile" value="<%=ownerfile%>"/>
                       <input type="hidden" name="consumername" value="<%=name%>"/>

                        <td><input type="submit" value="Download"/></td></tr></form>
