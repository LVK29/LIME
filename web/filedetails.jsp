  ...
  %>
    ...
    <div class="mainmenu-area">
     ...
     <div class="col-md-12"><br/><br/>
         ...
         <table align="center" cellpadding="7" border="6">
             <tr><td>Name</td><td>Email</td><td>File</td><td>Watermark</td><td>Request Link</td></tr>
              <%
               Connection con=databaseConnectivity.getconnection();
               Statement  st=con.createStatement();
                 String query="select * from fdetail";
               ...
               %>
                <form action="filerequestdetail"><tr><td><%=ownername%></td><td><%=owneremail%></td><td><%=ownerfile%></td><td><img src= "<%=waterimg%>" alt="fprint view" style="width:150px;height:150px"></td>
                       <input type="hidden" name="requester_name" value="<%=name%>"/>
                       <input type="hidden" name="requester_email" value="<%=email%>"/>
                        <input type="hidden" name="owner_name" value="<%=ownername%>"/>
                        <input type="hidden" name="owner_email" value="<%=owneremail%>"/>
                        <input type="hidden" name="owner_file" value="<%=ownerfile%>"/>
                        <td><input type="submit" value="Send Request"/></td></tr></form>
